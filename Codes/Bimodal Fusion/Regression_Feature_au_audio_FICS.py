# -*- coding: utf-8 -*-
"""Regression_Feature_au_audio_FICS.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13IqlxMBikzEmcuXx61e7uVBmhE5HgIyl
"""
...
def model_call(chunk_time, label, seqLen, final_model, callback):
    ...
    Audio_train_data_path = outer_directory + 'Audio_chunk_'+ str(chunk_time)+'_train.npy'
    Audio_train_label_path = outer_directory + 'Label_chunk_'+ str(chunk_time)+'_train_' + label+ '.npy'
    Audio_test_data_path = outer_directory + 'Audio_chunk_'+ str(chunk_time)+'_test.npy'
    Audio_test_label_path = outer_directory + 'Label_chunk_'+ str(chunk_time)+'_test_' + label+ '.npy'
    Audio_val_data_path = outer_directory + 'Audio_chunk_'+ str(chunk_time)+'_val.npy'
    Audio_val_label_path = outer_directory + 'Label_chunk_'+ str(chunk_time)+'_val_' + label+ '.npy'

    AU_train_data_path = outer_directory + 'AU_chunk_'+ str(chunk_time)+'_train.npy'
    AU_test_data_path = outer_directory + 'AU_chunk_'+ str(chunk_time)+'_test.npy'
    AU_val_data_path = outer_directory + 'AU_chunk_'+ str(chunk_time)+'_val.npy'
    ...
    zero_bias_history = final_model.fit([train_au, train_audio], train_labels, epochs = 250, batch_size = 100, validation_data = ([val_au, val_audio],val_labels), callbacks=[callback])
    y_pred_train = final_model.predict([train_au, train_audio])
    y_pred_train = np.around(y_pred_train,3)
    y_pred_test = final_model.predict([test_au, test_audio])
